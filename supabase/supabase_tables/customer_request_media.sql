...
create index IF not exists customer_request_media_request_idx on public.customer_request_media using btree (request_id, sort_order asc) TABLESPACE pg_default;
