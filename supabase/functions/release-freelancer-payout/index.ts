...
async function buildReceiptPdf(title: string, subtitle: string, lines: string[]) {
  ...
  drawReceiptText(page, "Generated by Carvver", {
    x: 48,
    y: 44,
    size: 10,
    font: regularFont,
    ...
    if (action === "release") {
      ...
      const freelancerReceiptBytes = await buildReceiptPdf(
        ...
        [
          ...
          `Net payout released: ${netPayoutAmount}`,
          `Destination: ${destinationMethod} / ${destinationReference}`,
          `Provider reference: ${providerReferenceForReceipt}`,
      ...
      const customerReceiptBytes = await buildReceiptPdf(
        ...
        [
          ...
          `Customer: ${customerName}`,
          `Freelancer: ${freelancerName}`,
          `Customer total: ${customerTotalAmount}`,
          `Freelancer payout released: ${netPayoutAmount}`,
          `Original payment reference: ${originalPaymentReference}`,
          `Provider reference: ${providerReferenceForReceipt}`,
