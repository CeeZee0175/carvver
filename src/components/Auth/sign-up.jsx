...
function GoogleIcon() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" className="signUpSocial__icon">
      ...
      />
      <path
        d="M12 22c2.76 0 5.07-.91 6.76-2.47l-3.3-2.56c-.91.61-2.08.98-3.46.98-2.66 0-4.91-1.8-5.72-4.21H2.87v2.64A10 10 0 0 0 12 22Z"
        fill="#34A853"
      />
      <path
        d="M6.28 13.74A5.99 5.99 0 0 1 6 12c0-.61.1-1.2.28-1.74V7.62H2.87A10 10 0 0 0 2 12c0 1.61.39 3.14 1.07 4.38l3.21-2.64Z"
        fill="#FBBC05"
      />
      <path
        d="M12 6.05c1.5 0 2.85.52 3.91 1.53l2.93-2.93C17.06 2.99 14.75 2 12 2a10 10 0 0 0-9.13 5.62l3.41 2.64C7.09 7.85 9.34 6.05 12 6.05Z"
        fill="#EA4335"
      />
    </svg>
  );
...
function FacebookIcon() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" className="signUpSocial__icon">
      <path
        fill="currentColor"
        d="M13.5 21v-7h2.35l.4-3h-2.75V9.13c0-.87.24-1.47 1.49-1.47H16.4V5a19.2 19.2 0 0 0-2.04-.1c-2.02 0-3.4 1.23-3.4 3.5V11H8.7v3h2.26v7h2.54Z"
      />
    </svg>
  );
}
...
function TwitterIcon() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" className="signUpSocial__icon">
      <path
        fill="currentColor"
        d="M18.9 2H22l-6.77 7.74L23 22h-6.1l-4.77-6.23L6.7 22H3.58l7.24-8.28L1 2h6.25l4.31 5.68L18.9 2Zm-1.07 18h1.69L6.32 3.9H4.5L17.83 20Z"
      />
    </svg>
  );
}
    ...
    <div className="signUpToggle" role="tablist" aria-label="Choose account type">
      <div className="signUpToggle__inner">
        <div className="signUpToggle__slot">
          {value === "customer" && (
            <motion.span
              layoutId="signUpToggleLine"
              className="signUpToggle__line"
        ...
        <span className="signUpToggle__sep" aria-hidden="true">
          |
        </span>
        ...
        <div className="signUpToggle__slot">
          ...
          <motion.button
            type="button"
            role="tab"
            aria-selected={value === "freelancer"}
...
function SocialButton({ icon, label, onClick }) {
  return (
    <motion.button
      type="button"
      className="signUpSocial"
      whileHover={{ y: -2, scale: 1.02 }}
      whileTap={{ scale: 0.97 }}
      transition={{ type: "spring", stiffness: 360, damping: 24 }}
      onClick={onClick}
    >
      <span className="signUpSocial__iconWrap" aria-hidden="true">
        {icon}
      </span>
...
export default function SignUp() {
  ...
  const handleSubmit = (e) => {
    ...
    localStorage.setItem("carvverUserFirstName", firstName || "there");

    if (role === "customer") {
        localStorage.setItem("carvverCustomerFirstName", firstName || "there");
        navigate("/dashboard/customer");
        return;
    }

    console.log("Freelancer dashboard coming soon");
    };
        ...
        >
          ...
          <div className="signUpCard__header">
            ...
            <p className="signUpCard__sub">
              <TypewriterText
                ...
                speed={24}
                initialDelay={420}
                className="signUpCard__subText"
              />
            </p>
          </div>

          <motion.div
            className="signUpCard__toggleWrap"
            initial={{ opacity: 0, y: 8 }}
            animate={inView ? { opacity: 1, y: 0 } : {}}
          ...
          >
            <div className="signUpRow signUpRow--two">
              <label className="signUpFieldBlock">
                ...
                <div className="signUpField">
                  <span className="signUpField__iconWrap" aria-hidden="true">
                    <User className="signUpField__icon" />
                  </span>
                  <input
                    className="signUpField__control"
                    type="text"
                    name="firstName"
                    placeholder="John"
              ...
              {role === "freelancer" && (
                ...
                >
                  <label className="signUpFieldBlock">
                    ...
                    <div className="signUpField">
                      <span className="signUpField__iconWrap" aria-hidden="true">
                        <MapPinned className="signUpField__icon" />
                      </span>
                      <input
                        className="signUpField__control"
                        type="text"
            ...
            <label className="signUpFieldBlock">
              ...
              <div className="signUpField">
                <span className="signUpField__iconWrap" aria-hidden="true">
                  <Mail className="signUpField__icon" />
                </span>
                <input
                  className="signUpField__control"
                  type="email"
            ...
            <label className="signUpFieldBlock">
              ...
              <div className="signUpField signUpField--password">
                <span className="signUpField__iconWrap" aria-hidden="true">
                  <Lock className="signUpField__icon" />
                </span>

                <input
                  className="signUpField__control signUpField__control--password"
                ...
                >
                  {showPassword ? (
                    <EyeOff className="signUpField__toggleIcon" />
                  ) : (
                    <Eye className="signUpField__toggleIcon" />
                  )}
                </button>
              </div>
            </label>
            ...
            <div className="signUpChecks">
              <label className="signUpCheck signUpCheck--top">
                ...
                <span className="signUpCheck__text">
                  I agree to the{" "}
                  <button type="button" className="signUpCheck__linkBtn">
          ...
          <motion.div
            className="signUpSocials"
            initial={{ opacity: 0, y: 8 }}
            animate={inView ? { opacity: 1, y: 0 } : {}}
            transition={{ duration: 0.5, ease: [0.2, 0.95, 0.2, 1], delay: 0.86 }}
          >
            <SocialButton icon={<GoogleIcon />} label="Google" onClick={() => console.log("Google clicked")} />
            <SocialButton icon={<FacebookIcon />} label="Facebook" onClick={() => console.log("Facebook clicked")} />
            <SocialButton icon={<TwitterIcon />} label="Twitter" onClick={() => console.log("Twitter clicked")} />
          </motion.div>

          <motion.div
            className="signUpBottomPrompt"
            initial={{ opacity: 0, y: 8 }}
            animate={inView ? { opacity: 1, y: 0 } : {}}
