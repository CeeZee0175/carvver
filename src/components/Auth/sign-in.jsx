...
function SocialButton({ icon, label, onClick }) {
  return (
    <motion.button
      ...
      onClick={onClick}
    >
      <span className="signInSocial__iconWrap" aria-hidden="true">
        {icon}
      </span>
